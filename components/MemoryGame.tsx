      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          >
            ...
            >
              Test your memory! Flip cards to find matching pairs.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[#C9FF00] text-gray-900 font-bold px-6 py-4 rounded-lg hover:bg-[#B8E600] transition-colors"
              style={{ fontFamily: "var(--font-absans), sans-serif" }}
            >
              New Game
            </motion.button>
          ...
          <AnimatePresence>
            {isGameComplete && (
              ...
              >
                <div className="bg-[#C9FF00] rounded-lg p-6 md:p-8 max-w-md mx-auto">
                  <h3
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="mt-4 bg-gray-900 text-white font-bold px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors"
                    style={{ fontFamily: "var(--font-absans), sans-serif" }}
                  >
                    Play Again
                  </motion.button>
