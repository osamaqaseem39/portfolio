        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full max-w-xs px-5 py-2.5 bg-[#14A800] text-white font-bold rounded-lg text-sm hover:bg-[#0F7F00] transition-colors"
              style={{ fontFamily: "var(--font-absans), sans-serif" }}
            >
              Hire on Upwork
            </motion.a>
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full max-w-xs px-5 py-2.5 bg-[#1DBF73] text-white font-bold rounded-lg text-sm hover:bg-[#19A866] transition-colors"
              style={{ fontFamily: "var(--font-absans), sans-serif" }}
            >
              Hire on Fiverr
            </motion.a>
